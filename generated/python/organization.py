...
class Organization:
    ...
    def from_dict(obj: Any) -> 'Organization':
        ...
        legal_name = from_union([from_str, from_none], obj.get("legalName"))
        ...
        return Organization(display_name, contacts, country, created_at, is_active, legal_name, local_ids, slug, tax_ids, updated_at, wallet, website)
    ...
    def to_dict(self) -> dict:
        ...
        if self.legal_name is not None:
            result["legalName"] = from_union([from_str, from_none], self.legal_name)
